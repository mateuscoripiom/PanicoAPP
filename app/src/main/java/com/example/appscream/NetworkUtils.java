...
public class NetworkUtils {
    ...
    private static final String GERAL_URL = "https://api.themoviedb.org/3/";
    ...
    static String buscaInfoColecao(String queryString) {
        HttpURLConnection urlConnection = null;
        BufferedReader reader = null;
        String bookJSONString = null;
        try {
            // Construção da URI de Busca
            Uri builtURI = Uri.parse(GERAL_URL).buildUpon()
